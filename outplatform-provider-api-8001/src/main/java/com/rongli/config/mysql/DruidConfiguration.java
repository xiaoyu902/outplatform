package com.rongli.config.mysql;
...
public class DruidConfiguration {
    ...
    */
   @Bean
   public FilterRegistrationBean<javax.servlet.Filter> statFilter() {
       //创建过滤器
       FilterRegistrationBean<javax.servlet.Filter> filterRegistrationBean = new FilterRegistrationBean(new WebStatFilter());
       //设置过滤器过滤路径
